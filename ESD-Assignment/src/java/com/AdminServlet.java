...
public class AdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("tbl").equals("provMem")){
            String msg="No users";
            try {
            ...
            request.getRequestDispatcher("/WEB-INF/provisionalMembers.jsp").forward(request, response);
        }
        if (request.getParameter("tbl").equals("processMembership")){
            String msg="No users";
            try {
                msg = dbBean.retrieve(qryProvisionalMemberApplications);
            } catch (SQLException ex) {
        ...
        if (request.getParameter("tbl").equals("processClaims")){
            String msg="No users";
            try {
                msg = dbBean.retrieve(qryProvisionalMemberApplications);
            } catch (SQLException ex) {
        ...
        ///////////////////////////////////////////////////////////
            ...
            request.getRequestDispatcher("/WEB-INF/memDetails.jsp").forward(request, response);
        }
        //////////////////////////////////////////////////////////
