...
public class MemberServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("tbl").equals("Update")){
            ...
            dbBean.deactivate(MemberLogin.name);
            System.out.println(MemberLogin.name);
            request.getRequestDispatcher("index.jsp").forward(request, response);    
        }
        else if(request.getParameter("tbl").equals("Resume")){
            PrintWriter out = response.getWriter();
            dbBean.resumeUser(MemberLogin.name);
            System.out.println(MemberLogin.name);
            request.getRequestDispatcher("index.jsp").forward(request, response);   
            ...
            request.setAttribute("nameofuser", request.getParameter("username"));
