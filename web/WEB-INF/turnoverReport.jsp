...
<html lang="en">
    ...
    <body>
        ...
        <form method="POST" action="Turnover.do"> 
            ...
            <div class="result">
               Total Fee Revenue:  <text><%=(String) (session.getAttribute("queryIncomeDetails"))%><%=(String) (session.getAttribute("queryIncome"))%></text><br/>
            </div>
            <div class ="result">
                Total Claims: <text><%=(String) (session.getAttribute("queryPayoutDetails"))%><%=(String) (session.getAttribute("queryPayout"))%></text><br/>
            </div>
        </form>
